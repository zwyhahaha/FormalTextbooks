# Bubeck Convex Optimization / Section 3.6.2 — Acceleration
...
|--------|--------|------|------|
| <span data-status="pending"><span class="status-badge status-pending">Pending</span></span> | [Lemma 3.16](../results/lemma-3-16.md) | Lemma 3.16 | [Lean](https://github.com/zwyhahaha/FormalTextbooks/blob/main/proofs/Bubeck_convex_optimization/Lemma316.lean) |
