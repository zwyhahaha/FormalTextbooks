...
| Field | Value |
|-------|-------|
| Display name | Theorem 6.13 |
| Proof file status | `missing` |
| Tracker status | `pending` |
| Computed status | `pending` |
| Proof time | — |
| Lean file | [proofs/Bubeck_convex_optimization/Theorem613.lean](https://github.com/zwyhahaha/FormalTextbooks/blob/main/proofs/Bubeck_convex_optimization/Theorem613.lean) |
...
- Previous: [Theorem 6.11](./theorem-6-11.md)
- Next: [Lemma 6.14](./lemma-6-14.md)
