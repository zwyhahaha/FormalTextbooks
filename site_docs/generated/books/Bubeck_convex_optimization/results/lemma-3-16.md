...
[Bubeck Convex Optimization](../index.md) / [Chapter 3](../chapters/chapter-3.md) / [Section 3.6.2](../sections/section-3-6-2-acceleration.md)
...
| Field | Value |
|-------|-------|
| Display name | Lemma 3.16 |
| Proof file status | `missing` |
| Tracker status | `pending` |
| Computed status | `pending` |
| Proof time | — |
| Lean file | [proofs/Bubeck_convex_optimization/Lemma316.lean](https://github.com/zwyhahaha/FormalTextbooks/blob/main/proofs/Bubeck_convex_optimization/Lemma316.lean) |
| Source section | [papers/Bubeck_convex_optimization/sections/03_06_02_acceleration.md](https://github.com/zwyhahaha/FormalTextbooks/blob/main/papers/Bubeck_convex_optimization/sections/03_06_02_acceleration.md) |
...
- Previous: [Theorem 3.15](./theorem-3-15.md)
- Next: [Theorem 3.17](./theorem-3-17.md)
