...
| Field | Value |
|-------|-------|
| Display name | Theorem 3.10 |
| Proof file status | `missing` |
| Tracker status | `pending` |
| Computed status | `pending` |
| Proof time | — |
| Lean file | [proofs/Bubeck_convex_optimization/Theorem310.lean](https://github.com/zwyhahaha/FormalTextbooks/blob/main/proofs/Bubeck_convex_optimization/Theorem310.lean) |
...
- Previous: [Lemma 3.11](./lemma-3-11.md)
- Next: [Theorem 3.12](./theorem-3-12.md)
